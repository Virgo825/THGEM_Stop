...
public:
	...
	// get methods
	G4double GetDetectorSizeZ() {return (fCathodeThick + fTransformThick + fStopThick + fGasThick) * fNbOfLayer;}
	G4int GetNbOfLayer() {return fNbOfLayer;}
